...
import '../../Components/CommodityCategory/CommodityCategory.css'
...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const rows = [
    createData('PET', 'WHITE', 'Valenzuela Branch', 'Add | Delete', '504 KGS','00', '06/20/2023 4:59'),
    createData('PET', 'GREEN', 'ReCyPat Recycle Shop', 'Add | Delete', '53 KGS','00','06/20/2023 4:59'),
    createData('PET', 'LUMINA', 'Chester and Friends Junkshop', 'Add | Delete', '105 KGS','00', '06/20/2023 4:59'),
    createData('PET', 'WHITE', 'Nits candle Junkshop', 'Add | Delete', '45 KGS','00', '06/20/2023 4:59'),
    createData('PET', 'LUMINA', 'Mark Nyi Shop all', 'Supplier', '154 KGS','00', '06/20/2023 4:59'),
  ];
...
<div class="master-list-table-Fxu">
  ...
  <div class="auto-group-9feh-SAm">
    ...
    <div class="group-17-VqB">
      <p class="master-list-qPF">Commodity Category</p>
 ...
 <div class="group-103-RP7">
   <div class="add-new-user-pop-up-Lky">
     <div class="group-98-HgD">
       <div class="lists-pref-oneline-text-y3F">Add Category </div>
       ...
       <CustomInput class="frame-133-DVK" aria-label="Demo input" placeholder="Enter Category" />
     ...
     <img class="icon-close-mny" src={closeicon} onClick={handleClose}/>
